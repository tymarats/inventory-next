    ...
    <cx>
        <div class="page-body audit-log" controller={Controller}>
            ...
            <div class="audit-toolbar">
                ...
                <Button
                    mod="hollow"
                    class={{ "audit-filters-toggle": true, "audit-filters-toggle-open": s.filtersOpen }}
            ...
            <div class="audit-results-head">
                ...
                <Button mod="hollow" class="audit-sort" onClick="toggleSort">
                    <Icon name="newestFirst" class="size-4" visible={newestFirst} />
                    <Icon name="oldestFirst" class="size-4" visible={oldestFirst} />
                    <span
                        text={expr(s.sort, (sort) => (sort === "time" ? "Oldest first" : "Newest first"))}
                    />
                </Button>
            </div>
            ...
            <div class={{ "audit-list": true, "audit-list-loading": s.loading }} visible={notEmpty}>
                ...
                <Repeater records={s.rows} recordAlias={m.$row} keyField="id">
                    <div class="audit-day" visible={hasValue(m.$row.dayHeading)} text={m.$row.dayHeading} />
                    <button
                        type="button"
                        class="audit-row"
                        onClick={(_e: unknown, { store, controller }: any) =>
            ...
            <div visible={expr(s.total, (t) => t > 0)}>
                <Pager state={s.pager} onPage={(page, instance) => instance.controller.goTo(page, true)} />
            </div>
        </div>
    </cx>
));
